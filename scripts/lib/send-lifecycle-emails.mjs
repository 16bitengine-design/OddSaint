...
// client-side — see syncUserTimezone in src/lib/lifecycleEmail.ts). This script computes each
...
import {
  ...
  countSentToday,
  dailySubscriptionNudgeEmail,
  dailySaintsLockNudgeEmail,
} from './lib/lifecycleEmail.mjs';
